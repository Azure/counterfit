...
* [Option 1: Deploy ML Security Evasion Competition Docker Image](#Option-1-Machine-Learning-Security-Evasion-Competition-using-Docker)
...
Then, take a look at the tutorials for each track in the Attacker Challenge:
* [docs/antimalware.md](docs/antimalware.md)
* [docs/antiphishing.md](docs/antiphishing.md)

### Option 1: Machine Learning Security Evasion Competition using Docker
For more details about the using Counterfit for the Machine Learning Security Evasion Competition, visit [docs/getting_started.md](docs/getting_started.md).
