...
class MovieReviewsTarget(CFTarget):
    ...
    endpoint = f"movie_reviews/movie_reviews_sentiment_analysis.pt"
    input_shape = (1,)
    output_classes = [0, 1]  # textattack requires these to be integers
    classifier = "blackbox"
    sample_input_path = f"movie_reviews/movie-reviews-scores-full.csv"
    vocab_file = f"movie_reviews/movie-reviews-vocab.pkl"
    X = []
